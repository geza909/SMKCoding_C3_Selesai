...
import com.example.covid_19.CRUD_firebase_DB.BeritaModel
import com.google.firebase.database.FirebaseDatabase

class BeritaAdapter (val mCtx : Context, val layoutResId : Int, val brtList :List<BeritaModel> ) :
    ArrayAdapter<BeritaModel>(mCtx,layoutResId,brtList) {
    ...
    fun showUpdateDialog(beritaModel: BeritaModel) {
        ...
        etJudul.setText(beritaModel.judul)
        etIsi.setText(beritaModel.isi)
        ...
        builder.setPositiveButton("update"){
            ...
            val berita = BeritaModel(beritaModel.id, judul, isi)
        ...
        builder.setNegativeButton("hapus"){p0,p1 ->
            val dbBrt= FirebaseDatabase.getInstance().getReference("berita").child(beritaModel.id!!)
            dbBrt.removeValue()
